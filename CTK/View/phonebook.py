...
class PhoneBook:
    def __init__(self, master, app):
        ...
        self.frame_container = customtkinter.CTkFrame(master=self.master, width=800, height=300)
    ...
    def create_list_friend(self):
        # Tạo frame_friend
        self.frame_friend = customtkinter.CTkFrame(master=self.frame_list_fr, width=800, height=300)
    ...
    def create_frame_group(self):
        # Tạo frame_group
        self.frame_group = customtkinter.CTkFrame(master=self.frame_list_fr, width=800, height=300)
